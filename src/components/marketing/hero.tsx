        ...
        <div className="flex flex-col items-center justify-center w-full z-10">
          ...
          <Container delay={0.1}>
            <h2 className="text-balance !leading-[1.25] text-center text-5xl md:text-6xl font-semibold tracking-tight mt-6 w-full">
              ...
              <br className="hidden lg:inline-block" /> Custom Digital Solutions
            </h2>
          </Container>

          <Container delay={0.2}>
            <p className="text-base md:text-lg font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
              From concept to deployment, Zintronia builds innovative software
              solutions that drive growth and success for businesses of all
              sizes
            </p>
          </Container>
          ...
          <Container delay={0.3}>
            <div className="mt-6">
              <Link href={"https://calendly.com/zintronia/30min"}>
                <Button size="md">Get Your Free Consultation</Button>
              </Link>
            </div>
          </Container>
