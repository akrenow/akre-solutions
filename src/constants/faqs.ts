export const FAQS = [
    ...
    },
    {
        ...
        answer: "AI and automation can transform your business by improving efficiency (reducing manual work by up to 80%), enhancing decision-making with data-driven insights, reducing operational costs, improving customer experiences, and enabling 24/7 operations. Our team can help identify the most impactful opportunities for your specific business context."
    }
];
...
export const QUESTIONS = [
    {
        title: "AI & Automation",
        description: "Intelligent solutions including AI integration, machine learning, and workflow automation to transform your business operations and drive efficiency."
    },
    {
        title: "Custom Development",
        description: "Tailored software solutions designed specifically for your business needs. From concept to deployment, we build applications that drive growth and efficiency."
    },
    {
    ...
    },
    {
        ...
        description: "Comprehensive cloud solutions including migration, architecture design, and management on leading platforms like AWS, Azure, and Google Cloud."
    }
];
